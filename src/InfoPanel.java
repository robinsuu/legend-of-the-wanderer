...
public class InfoPanel extends JPanel {
    ...
    private final JButton cmdButton;
    ...
    public void refreshData () {
        loadData(); // If it stops working, comment away this and start the game, create a new character and then remove the comment Note 171102: This should be fixed now
