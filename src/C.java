...
// C.java
// 
// All credit for this class to: http://crownlessking.com
// 
// Uses code from:
// http://crownlessking.com/projects/gui_console_input_output_in_java_jtextarea
//
// http://crownlessking.com/sites/all/files/source_codes/C.java
// 
// Creates a console in a graphical user interface.
//******************************************************************************
...
import javax.swing.JInternalFrame; // ***ADDED BY ROBINSUU***
import javax.swing.JDesktopPane; // ***ADDED BY ROBINSUU***
import javax.swing.JPanel; // ***ADDED BY ROBINSUU***
...
public final class C {
    ...
    public static class GUIConsoleIO {
        ...
        private void defaultStyles() {
            ...
            StyleConstants.setForeground(promptStyle, Color.GREEN); // Set the input color to green
        }
        
        private void initComponents() {
        	
        	// Create the main frame ***ADDED BY ROBINSUU***
    		JFrame mainFrame = new JFrame ("Legend of the Wanderer 2.0");
    		mainFrame.setDefaultCloseOperation (JFrame.EXIT_ON_CLOSE);
    		
    		frame2 = new JInternalFrame("Info"); // Add the info frame ***ADDED BY ROBINSUU***
    		infoPanel = new InfoPanel(); // Add the info panel ***ADDED BY ROBINSUU***
    		desktopPane = new JDesktopPane(); // Add the JDesktopFrame for holding the JInternalFrame
    		
    		// Crownlessking code below
            frame = new JInternalFrame("Credit to: crownlessking.com");
            pane = new JTextPane();
            ...
            Action enter = new AbstractAction() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    try {
                        //infoPanel.refreshData(); // ***ADDED BY ROBINSUU***
            ...
            // Add Action later for command history ***ADDED BY ROBINSUU***
            //pane.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_UP, 0, false), "up");
            //pane.getActionMap().put("up", up);

            // ***ADDED BY ROBINSUU BELOW***
            frame2.add(new JScrollPane(pane));
        	...
        	//frame.setSize(new Dimension (20, 20));
            ...
            frame2.setBounds(600, 0, 185, 560);
            
            // Display the main frame ***ADDED BY ROBINSUU***
        ...
        // ***ADDED BY ROBINSUU***
        // Change title of the info window
        public void setInfoTitle(final String title) 
        {
            SwingUtilities.invokeLater(new Runnable() 
            {
        ...
        public String nextLine() {
        	infoPanel.refreshData(); // ***ADDED BY ROBINSUU*** For updating the infoPanel GUI after every command
            return prompt();
        }
        ...
        private JInternalFrame frame2; // ***ADDED BY ROBINSUU***
        private JDesktopPane desktopPane; // ***ADDED BY ROBINSUU***
